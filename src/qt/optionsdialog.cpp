    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("IPO-light"), QVariant("light"));
    ui->theme->addItem(QString("IPO-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("IPO-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("IPO-traditional"), QVariant("trad"));
