    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Ipo Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Ipo Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  ipo-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Ipo in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 IPO, 0.1 IPO, 1 IPO and 10 IPO -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://ipopay.atlassian.net/wiki/display/DOC/PrivateSend\">https://ipopay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Ipo Core is shutting down...") + "<br /><br />" +
