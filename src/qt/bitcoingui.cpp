    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Ipo Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Ipo address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and ipo: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Ipo Core"), this);
    aboutAction->setStatusTip(tr("Show information about Ipo Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Ipo Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Ipo addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Ipo addresses"));
    ...
    openAction->setStatusTip(tr("Open a ipo: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Ipo Core help message to get a list with possible Ipo Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Ipo Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Ipo network", "", count));
}
...
{
    QString strTitle = tr("Ipo Core"); // default title
