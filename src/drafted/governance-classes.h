 ...
 *
 *   // network
 *   CIpoNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.ipo.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CIpoNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: IpoNetwork
// //   -- signature requirements : Key1(User)
// class CIpoNetworkVariable : public CGovernanceObject
// {
// private:
