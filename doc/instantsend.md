...
This mechanism has been integrated into Bitcore-Node-Ipo which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/ipopay/insight-api-ipo#web-socket-api](https://github.com/ipopay/insight-api-ipo#web-socket-api) 
* API: [https://github.com/ipopay/insight-api-ipo#instantsend-transactions](https://github.com/ipopay/insight-api-ipo#instantsend-transactions) 
...
By default, the Ipo Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Ipo Core daemon:
