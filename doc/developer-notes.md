...
Ipo Core is a multithreaded application, and deadlocks or other multithreading bugs
...
- ThreadSocketHandler : Sends/Receives data from peers on port 3200.
...
- ThreadRPCServer : Remote procedure call handler, listens on port 3201 for connections and services them.
...
However, in open source software such as Ipo Core, where everyone uses
...
pay attention to for reviewers of Ipo Core code.
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Ipo Core uses tinyformat, which is type safe. Leave them out to avoid confusion
