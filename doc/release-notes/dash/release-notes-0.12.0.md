...
Ipo Core version 0.12.0 is now available from:

  https://ipopay.io/downloads

Please report bugs using the issue tracker at github:

  https://github.com/ipopay/ipo/issues
...
backwards-compatible with pre-0.12 versions of Ipo Core or other software:
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/ipo/).
