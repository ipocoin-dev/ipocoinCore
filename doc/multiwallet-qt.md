...
Only requiring some minor changes is ipo.cpp.
...
Changes to ipo.cpp
----------------------
ipo.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
